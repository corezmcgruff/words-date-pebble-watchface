...
//hours
  ...
  text_layer_init(&s_data.label, GRect(0, 0, window.layer.frame.size.w, 50));
  text_layer_set_background_color(&s_data.label, GColorClear);
  text_layer_set_text_color(&s_data.label, GColorWhite);
  text_layer_set_font(&s_data.label, fonts_get_system_font(FONT_KEY_GOTHAM_42_BOLD));
...
// 00 minutes
  ...
  text_layer_init(&s_data_minutes.label,GRect(0, 38, window.layer.frame.size.w, 50));
  text_layer_set_background_color(&s_data_minutes.label, GColorClear);
  text_layer_set_text_color(&s_data_minutes.label, GColorWhite);
  text_layer_set_font(&s_data_minutes.label, fonts_get_system_font(FONT_KEY_GOTHAM_42_LIGHT));
...
// single digits
  ...
  text_layer_init(&s_data_sminutes.label,GRect(0, 76, window.layer.frame.size.w, 50));
  ...
  text_layer_set_font(&s_data_sminutes.label, fonts_get_system_font(FONT_KEY_GOTHAM_42_LIGHT));
...
//Date
  ...
  text_layer_init(&date.label, GRect(0, 114, window.layer.frame.size.w, 50));
  text_layer_set_background_color(&date.label, GColorClear);
  text_layer_set_text_color(&date.label, GColorWhite);
  text_layer_set_font(&date.label, fonts_get_system_font(FONT_KEY_GOTHAM_42_LIGHT));
